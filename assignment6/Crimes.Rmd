...
If you want to see the report without code, it's all available at this link : [report without code](http://rpubs.com/rdsn/131998) or at the link under each figure.
...
```{r,fig.align='center', fig.height= 3.5, fig.width= 10, message = FALSE}
library(ggplot2)
...
[report without code](http://rpubs.com/rdsn/131998)  
...
```{r,fig.align='center', fig.height= 4, fig.width= 14, message = FALSE}
library(ggplot2)
